...
@section('title') Awaiting Blogs @endsection
@section('styles')
	<!-- Bootstrap CSS -->
		...
		<div class="col-lg-12">
			<div class="card shadow mb-4">
				<div class="card-header py-3 d-flex flex-row align-items-center justify-content-center">
					<h6 class="m-0 font-weight-bold text-primary d-inline-block">Awaiting Blogs</h6>
					<!-- Button trigger modal -->
					{{-- <a href="{{ url('/createBlog') }}" class="btn btn-success"> Add Blog </a> --}}
				</div>
				<div class="card-body">
					<table class="table table-striped table-bordered w-100" id="userAwaitingBlogs">
...
@section('scripts')
	...
	<script src="{{ asset('backend/partials/userAwaitingBlog.js') }}" type="text/javascript"></script>
