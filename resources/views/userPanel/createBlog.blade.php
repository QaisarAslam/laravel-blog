	...
	<div class="row">
	    <div class="col-xl-12 col-lg-8">
	        <div class="card shadow mb-4">
	            ...
	            <div class="card-body">
					<form action="{{ url('/user/blogCreate') }}" method="POST" accept-charset="utf-8" enctype="multipart/form-data">
					    @csrf
					    <div class="form-row">
					    ...
					    {{-- <div class="form-check mb-2">
					    	<input type="checkbox" name="active" id="active" value="{{old('active')}}" class="form-check-input" checked="">
