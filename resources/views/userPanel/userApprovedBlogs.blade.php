	...
	<div class="row">
		<div class="col-lg-12">
			<div class="card shadow mb-4">
				...
				<div class="card-body">
					<table class="table table-striped table-bordered w-100" id="approvedBlogs">
...
@section('scripts')
	...
	<script src="{{ asset('backend/partials/userApprovedBlog.js') }}" type="text/javascript"></script>
